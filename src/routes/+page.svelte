<div class="flex flex-col items-center p-64">
    ...
    <div class="flex flex-col">
        ...
        <p class="text-2xl mt-8">Photography is such a method to invoke thought and emotions and, in a way, a method to make the universe exist.</p>
        <p class="text-2xl mt-8">
            Looking at the following collection of photos,
            every person will think and see and feel different things to next person, <br />
            and every photographer who takes a photo of the same object will think and feel and see different things when taking that photo to the next photographer, <br />
        ...
        <p class="text-2xl mt-8">That's what makes life...</p>
    </div>
    <div class="flex flex-col mt-32">
        <div class="flex flex-row items-center">
            ...
            />
            <div class="flex flex-col">
                <p class="text-3xl ml-32">This is a photo of some buildings. In the foreground, some small family homes, in the background some massive office and apartment buildings. The buildings are seemingly lined up in order of age, where the buildings closet to me are just being built, while the buildings at the back are massive and old, consumed by nature.</p>
                <p class="text-3xl ml-32 mt-8">This is representative of the passage of life - the buildings are experiencing age. Even though they are built out of lifeless objects like bricks and windows and foundations and carpet, they are seemingly alive and getting older - just like the humans who built them.</p>
                <p class="text-3xl ml-32 mt-8">This, perhaps, shows how humans not only perceive and experience and live, but they can pass on that ability to that which they perceive and experience.</p>
